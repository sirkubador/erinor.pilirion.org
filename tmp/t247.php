...
<h2>Seznam postav</h2>
<p>Zatím není ještě kompletní, popisy se doplní průběžně. Zatím je možné si vybírat a rozmýšlet, přihlašování bude možné za týden <strong>(20. 2. 2011)</strong></p>
<table>
<thead>
...
<tbody>
   ...
   <tr class="<?php if($postava['zabrano'] != 0): ?> zabrano <? endif; ?>"><td><?=$postava['jmeno'];?></td><td><?=$pohlavi[(int) $postava['pohlavi']];?></td><td><?=$postava['popis'];?></td><td><?php if($postava['schvaleno'] == 0):?><a href="prihlaseni_postavy.php?id=<?=$postava['id'];?>">Přihlásit</a><? endif; ?></td></tr>
   <?php endforeach; ?>
